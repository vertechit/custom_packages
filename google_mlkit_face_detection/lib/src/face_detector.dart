...
class FaceDetector {
  static const MethodChannel _channel = MethodChannel('google_mlkit_face_detector');
  ...
  Future<List<Face>> processImage(InputImage inputImage) async {
    final result = await _channel.invokeListMethod<dynamic>('vision#startFaceDetector', <String, dynamic>{
  ...
  Future<void> close() => _channel.invokeMethod<void>('vision#closeFaceDetector', {'id': id});
}
